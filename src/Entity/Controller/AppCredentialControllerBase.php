...
abstract class AppCredentialControllerBase implements AppCredentialControllerInterface {
   ...
   *   The event dispatcher service.
   */
  public function __construct(string $owner, string $app_name, SDKConnectorInterface $connector, AppCacheInterface $app_cache, EventDispatcherInterface $event_dispatcher) {
    $this->owner = $owner;
  ...
  public function addProducts(string $consumerKey, array $apiProducts): AppCredentialInterface {
    ...
    $this->appCache->removeAppIdsFromCacheByOwner($this->owner, [$this->appName]);
    return $credential;
  }
