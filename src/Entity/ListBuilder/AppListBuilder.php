...
class AppListBuilder extends EdgeEntityListBuilder {
   ...
   */
  public function __construct(EntityTypeInterface $entity_type, EntityTypeManagerInterface $entity_type_manager, RendererInterface $renderer, RequestStack $request_stack, TimeInterface $time, AppWarningsCheckerInterface $app_warnings_checker, ConfigFactoryInterface $config_factory) {
    if (!$config_factory) {
