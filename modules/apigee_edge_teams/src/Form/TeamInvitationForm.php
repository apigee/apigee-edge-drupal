...
class TeamInvitationForm extends ConfigFormBase {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    if ((int) $form_state->getValue('team_invitation_expiry') < 1) {
      $form_state->setErrorByName('team_invitation_expiry', $this->t('Expiry days must be 1 or more days.'));
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->configFactory->getEditable('apigee_edge_teams.team_settings')
      ->set('team_invitation_expiry', $form_state->getValue(['team_invitation_expiry']))
