...
class TeamInvitationForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['email_for_new_users']['team_invitation_email_new_body'] = [
      ...
      '#description' => $this->t('Available tokens: [site:name], [site:url], [team_invitation:team_name], [team_invitation:url_register], [team_invitation:url_accept], [team_invitation:url_decline] and [team_invitation:expiry_days].'),
    ];
