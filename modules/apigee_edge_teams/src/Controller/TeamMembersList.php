...
class TeamMembersList extends ControllerBase {
   ...
   * @param \Drupal\Core\Extension\ModuleExtensionList|null $module_handler
   *   The module handler.
